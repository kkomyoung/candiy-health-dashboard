		...
		<div>
			<section className="pt-4 flex flex-col items-center mb-6">
				<div className="text-center mb-6">
					<h2 className="text-2xl md:text-3xl font-bold mb-3 break-keep">안녕하세요 {getUser()?.name}님!</h2>
					<p className="text-sm md:text-lg text-gray-600 break-keep">
						개인정보를 입력하고 건강검진 결과를 조회해보세요
					</p>
				</div>
			</section>

			<section className="max-w-lg mx-auto">
				<UserInfoForm onSubmit={requestAuth} />
			</section>
